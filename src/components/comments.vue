<template>
    <div id="comment-root">
        <div style="padding: 10px;">
            <span>{{comments}}</span>
            <div v-for='item in commentData' :key="item.commentId" class="comment-info-root">
                <div class="comment-user-info">
                    <div>
                        <img :src="!item.commentIcon?require(`@/assets/user_boy.png`):item.commentIcon" alt=""
                            class="comment-ic" @click.stop="go2fchain(item.visitorUrl)">
                        <span :class="!item.visitorUrl?'anonymous-visitor':'visitor2'"
                            @click.stop="go2fchain(item.visitorUrl)">{{item.commentNick}}</span>
